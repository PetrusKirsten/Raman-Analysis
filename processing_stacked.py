...
# apply pipes
cropped_powder_st = cropping.apply(powder_st)
cosmic_rays_powder_st = cosmic_rays.apply(powder_st)
filtering_powder_st = filtering.apply(powder_st)
...
raw_chart = rs.plot.spectra(
    [cropped_powder_st, cosmic_rays_powder_st, filtering_powder_st, baseline_powder_st, minmax_powder_st],
    title=filetitle,
    plot_type='stacked',
